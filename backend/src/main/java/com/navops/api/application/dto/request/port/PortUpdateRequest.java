...
@Schema(description = "DTO para la actualización de un Puerto existente")
public record PortUpdateRequest(
    ...
    @NotBlank(message = "El tipo de muelle es obligatorio")
    ...
    @NotBlank(message = "El estado del puerto es obligatorio")
    @Schema(description = "Estado del puerto", example = "OPERATIONAL")
    String status
) {}
