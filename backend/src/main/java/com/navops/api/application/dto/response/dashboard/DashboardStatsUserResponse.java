package com.navops.api.application.dto.response.dashboard;

import io.swagger.v3.oas.annotations.media.Schema;

@Schema(description = "Respuesta de cantidad de usuarios total, activos y disponibles")
public record DashboardStatsUserResponse (
   ...
   /*     @Schema(example = "5", description = "Tripulantes que no están asignados a ningún viaje actual")
