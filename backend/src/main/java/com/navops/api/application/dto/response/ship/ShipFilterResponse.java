...
@Schema(description = "Respuesta paginada para filtros avanzados de barcos.")
public record ShipFilterResponse(

        @Schema(description = "Lista de barcos que coinciden con los filtros")
        List<ShipSummaryResponse> content,
