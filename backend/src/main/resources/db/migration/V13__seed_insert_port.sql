...
VALUES
    ...
    (gen_random_uuid(), 'Puerto Sud Dock - Terminal 1', 'COMMERCIAL', 'SOLID_STRUCTURE', 'ARSUD1', '+54 11 4343-0001', 'info@sudt1.gob.ar', 'http://www.sudt1.com.ar', 'UTC-3', -34.6322, -58.3588, 8, 250.0, 9.5,
     (SELECT id FROM countries WHERE iso_code = 'AR' LIMIT 1), (SELECT id FROM provinces WHERE name = 'Gran Buenos Aires' LIMIT 1), (SELECT id FROM cities WHERE name = 'Avellaneda' LIMIT 1), 'OPERATIONAL', true, 0, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'Astillero Boca Central', 'INDUSTRIAL', 'FLOATING', 'ARABC2', '+54 11 4343-0002', 'contacto@astilleroboca.com', 'http://www.astilleroboca.com.ar', 'UTC-3', -34.6401, -58.3612, 3, 180.0, 7.0,
     (SELECT id FROM countries WHERE iso_code = 'AR' LIMIT 1), (SELECT id FROM provinces WHERE name = 'Gran Buenos Aires' LIMIT 1), (SELECT id FROM cities WHERE name = 'Lomas de Zamora' LIMIT 1), 'UNDER_MAINTENANCE', true, 0, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'Terminal Logística Riachuelo', 'LOGISTIC', 'SOLID_STRUCTURE', 'ARTLR3', '+54 11 4343-0003', 'logistica@riachuelo.com', null, 'UTC-3', -34.6510, -58.3745, 12, 220.0, 8.5,
     (SELECT id FROM countries WHERE iso_code = 'AR' LIMIT 1), (SELECT id FROM provinces WHERE name = 'Gran Buenos Aires' LIMIT 1), (SELECT id FROM cities WHERE name = 'Lanus' LIMIT 1), 'FULL', true, 0, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'Puerto Ribera Barracas', 'FISHING', 'PIER_JETTY', 'ARPRB4', '+54 11 4343-0004', 'ribera@barracasports.com', 'http://www.riberabarracas.com', 'UTC-3', -34.6554, -58.3810, 5, 120.0, 6.0,
     (SELECT id FROM countries WHERE iso_code = 'AR' LIMIT 1), (SELECT id FROM provinces WHERE name = 'Gran Buenos Aires' LIMIT 1), (SELECT id FROM cities WHERE name = 'Ezeiza' LIMIT 1), 'CLOSED', true, 0, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'Marina Turística Belgrano', 'TOURISTIC', 'FLOATING', 'ARMTB5', '+54 11 4343-0005', 'marina@belgranoclub.com', 'http://www.marinabelgrano.com.ar', 'UTC-3', -34.5420, -58.4310, 25, 45.0, 4.5,
     (SELECT id FROM countries WHERE iso_code = 'AR' LIMIT 1), (SELECT id FROM provinces WHERE name = 'Gran Buenos Aires' LIMIT 1), (SELECT id FROM cities WHERE name = 'Monte Grande' LIMIT 1), 'OPERATIONAL', true, 0, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'Puerto de Enlace Norte', 'COMMERCIAL', 'DOLPHIN', 'ARPEN6', '+54 11 4343-0006', 'enlacenorte@navops.com', null, 'UTC-3', -34.5512, -58.4201, 4, 310.0, 11.0,
     (SELECT id FROM countries WHERE iso_code = 'AR' LIMIT 1), (SELECT id FROM provinces WHERE name = 'Gran Buenos Aires' LIMIT 1), (SELECT id FROM cities WHERE name = 'Quilmes' LIMIT 1), 'INACTIVE', false, 0, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'Terminal Multimodal Boedo Cargo', 'LOGISTIC', 'SOLID_STRUCTURE', 'ARTMB7', '+54 11 4343-0007', 'cargo@boedoterminal.com', 'http://www.boedocargo.com', 'UTC-3', -34.6215, -58.4110, 6, 150.0, 7.5,
     (SELECT id FROM countries WHERE iso_code = 'AR' LIMIT 1), (SELECT id FROM provinces WHERE name = 'Buenos Aires' LIMIT 1), (SELECT id FROM cities WHERE name = 'Mar del Plata' LIMIT 1), 'OPERATIONAL', true, 0, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'Puerto Seco de Integración', 'INDUSTRIAL', 'PIER_JETTY', 'ARPSI8', '+54 11 4343-0008', 'integracion@puertoseco.gob.ar', null, 'UTC-3', -34.6288, -58.4199, 2, 200.0, 8.0,
     (SELECT id FROM countries WHERE iso_code = 'AR' LIMIT 1), (SELECT id FROM provinces WHERE name = 'Buenos Aires' LIMIT 1), (SELECT id FROM cities WHERE name = 'Villa Gesell' LIMIT 1), 'CLOSED', true, 0, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'Terminal de Cruceros Caballito Sky', 'TOURISTIC', 'SOLID_STRUCTURE', 'ARTCS9', '+54 11 4343-0009', 'cruceros@caballitosky.com', 'http://www.caballitosky.com', 'UTC-3', -34.6130, -58.4420, 10, 330.0, 12.0,
     (SELECT id FROM countries WHERE iso_code = 'AR' LIMIT 1), (SELECT id FROM provinces WHERE name = 'Buenos Aires' LIMIT 1), (SELECT id FROM cities WHERE name = 'Olavarria' LIMIT 1), 'OPERATIONAL', true, 0, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'Dársena de Suministros Internos', 'COMMERCIAL', 'DOLPHIN', 'ARDSI1', '+54 11 4343-0010', 'suministros@caballitoport.com', null, 'UTC-3', -34.6190, -58.4495, 4, 190.0, 9.0,
     (SELECT id FROM countries WHERE iso_code = 'AR' LIMIT 1), (SELECT id FROM provinces WHERE name = 'Buenos Aires' LIMIT 1), (SELECT id FROM cities WHERE name = 'Junin' LIMIT 1), 'FULL', true, 0, NOW(), NOW());